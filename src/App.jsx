...
function App() {
  ...
  return (
    ...
    <div className="container">
      <div className="logo">
        <img src={IMAGE_URLS.logo} alt="SafeStories Logo" />
      </div>
      ...
      <div className="center-content">
        ...
        <button className="start-call-btn" onClick={async () => {
          ...
          <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path opacity="1" d="M56.1079 28.2264C54.5718 28.2264 53.3251 29.4549 53.3251 30.9746C53.3251 41.2391 44.868 49.5909 34.474 49.5909C24.0773 49.5909 15.6202 41.2391 15.6202 30.9746C15.6202 29.4549 14.3734 28.2264 12.8373 28.2264C11.3012 28.2264 10.0544 29.4549 10.0544 30.9746C10.0544 43.3415 19.5329 53.551 31.6912 54.9224V60.4517C31.6912 61.9688 32.9351 63.1999 34.474 63.1999C36.0102 63.1999 37.2569 61.9688 37.2569 60.4517V54.9224C49.4124 53.551 58.8908 43.3415 58.8908 30.9746C58.8908 29.4549 57.6441 28.2264 56.1079 28.2264" fill="#F1A937"/>
            <path d="M33.9689 43.7145H34.9763C41.8777 43.7145 47.4768 38.1879 47.4768 31.3724V18.0904C47.4768 11.2694 41.8777 5.74548 34.9763 5.74548H33.9689C27.0674 5.74548 21.4683 11.2694 21.4683 18.0904V31.3724C21.4683 38.1879 27.0674 43.7145 33.9689 43.7145" fill="#F1A937"/>
          </svg>
        </button>
